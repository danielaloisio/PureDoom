...
void  A_Light0(void *data);
void A_WeaponReady(void *data);
void A_Lower(void *data);
void A_Raise(void *data);
void A_Punch(void *data);
void A_ReFire(void *data);
void A_FirePistol(void *data);
void A_Light1(void *data);
void A_FireShotgun(void *data);
void A_Light2(void *data);
void A_FireShotgun2(void *data);
void A_CheckReload(void *data);
void A_OpenShotgun2(void *data);
void A_LoadShotgun2(void *data);
void A_CloseShotgun2(void *data);
void A_FireCGun(void *data);
void A_GunFlash(void *data);
void A_FireMissile(void *data);
void A_Saw(void *data);
void A_FirePlasma(void *data);
void A_BFGsound(void *data);
void A_FireBFG(void *data);
void A_BFGSpray(void *data);
void A_Explode(void *data);
void A_Pain(void *data);
void A_PlayerScream(void *data);
void A_Fall(void *data);
void A_XScream(void *data);
void A_Look(void *data);
void A_Chase(void *data);
void A_FaceTarget(void *data);
void A_PosAttack(void *data);
void A_Scream(void *data);
void A_SPosAttack(void *data);
void A_VileChase(void *data);
void A_VileStart(void *data);
void A_VileTarget(void *data);
void A_VileAttack(void *data);
void A_StartFire(void *data);
void A_Fire(void *data);
void A_FireCrackle(void *data);
void A_Tracer(void *data);
void A_SkelWhoosh(void *data);
void A_SkelFist(void *data);
void A_SkelMissile(void *data);
void A_FatRaise(void *data);
void A_FatAttack1(void *data);
void A_FatAttack2(void *data);
void A_FatAttack3(void *data);
void A_BossDeath(void *data);
void A_CPosAttack(void *data);
void A_CPosRefire(void *data);
void A_TroopAttack(void *data);
void A_SargAttack(void *data);
void A_HeadAttack(void *data);
void A_BruisAttack(void *data);
void A_SkullAttack(void *data);
void A_Metal(void *data);
void A_SpidRefire(void *data);
void A_BabyMetal(void *data);
void A_BspiAttack(void *data);
void A_Hoof(void *data);
void A_CyberAttack(void *data);
void A_PainAttack(void *data);
void A_PainDie(void *data);
void A_KeenDie(void *data);
void A_BrainPain(void *data);
void A_BrainScream(void *data);
void A_BrainDie(void *data);
void A_BrainAwake(void *data);
void A_BrainSpit(void *data);
void A_SpawnSound(void *data);
void A_SpawnFly(void *data);
void A_BrainExplode(void *data);
